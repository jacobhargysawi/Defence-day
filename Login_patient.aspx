<%@ Page Title="Patient Login" Language="C#" MasterPageFile="~/PatientMaster.master" AutoEventWireup="true" CodeBehind="Login_patient.aspx.cs" Inherits="HospitalManagementSystem.Login_patient" %>
                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="RegisterPatient.aspx" class="text-primary">Create an Account</a>
                        </div>
                    </div>
